...
//console.log(`${spacecraftName} takes ${daysToMars} to get to Mars`);
...
console.log(`${spacecraftName} takes ${getDaysToLocation(kilometersToMars)} to get to Mars`);
console.log(`${spacecraftName} takes ${getDaysToLocation(KilometersToMoon)} to get to Moon`);
...
class Spacecraft{
    ...
    public constructor(name:string,speedMph:number){
        this.name = name;
